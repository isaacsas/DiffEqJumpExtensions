...
function update_samples(p::DirectJumpAggregation, integrator, u, params, t)
...
function aggregate(aggregator::Direct, u, p, t, end_time, 
  ...
  DirectJumpAggregation(zero(t), 0, end_time, cur_rates, zero(t), rates, affects!, save_positions)
end
