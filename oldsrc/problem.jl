DiffEqJump.JumpProblem(prob,aggregator::AbstractAggregatorAlgorithm,rn::DiffEqBiological.AbstractReactionNetwork;kwargs...)  =
                 JumpProblem(prob,aggregator::AbstractAggregatorAlgorithm,rn.jumps...;kwargs...)

function DiffEqJump.JumpProblem(prob, aggregator::AbstractAggregatorAlgorithm, jumps::JumpSet;
...
# DiffEqJump.JumpProblem(prob,aggregator::Direct2,rn::DiffEqBiological.AbstractReactionNetwork;kwargs...) =
#                  JumpProblem(prob,aggregator::Direct2,rn.jumps...;kwargs...)

# function DiffEqJump.JumpProblem(prob, aggregator::Direct2, jumps::JumpSet;
#     save_positions=typeof(prob) <: AbstractDiscreteProblem ? (false, true) : (true, true))
...
# ########### Direct with FunctionWrappers #####################

# DiffEqJump.JumpProblem(prob,aggregator::DirectVEC,rn::DiffEqBiological.AbstractReactionNetwork;kwargs...) =
#                  JumpProblem(prob,aggregator::DirectVEC,rn.jumps...;kwargs...)

# function DiffEqJump.JumpProblem(prob, aggregator::DirectVEC, jumps::JumpSet;
#     save_positions=typeof(prob) <: AbstractDiscreteProblem ? (false, true) : (true, true))
